...
from routes import auth, subjects, nodes, research, questions, kg, blueprints, question_workbench, ingestion, kg_analytics
import file_db
...
app.include_router(kg_analytics.router)
